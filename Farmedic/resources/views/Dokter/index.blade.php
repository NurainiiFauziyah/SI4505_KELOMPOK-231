    ...
    <div class="box-body">
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tr>
          ...
          <th>Dokter</th>
          <th>Gambar</th>
          <th>Jam Kerja</th> <!-- Tambahkan kolom untuk menampilkan jam kerja -->
          <th>Harga Konsultasi (Rp)</th> <!-- Tambahkan kolom untuk menampilkan harga konsultasi -->
          <th></th>
        </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td>{{$item->dokter}}</td>
                <td><img src="{{ asset('storage/dokter/'.$item->gambar) }}" width="200px" height="200px"></td>
                <td>{{ $item->jam_mulai }} - {{ $item->jam_selesai }}</td> <!-- Tampilkan jam kerja -->
                <td>{{ $item->harga_konsultasi }}</td> <!-- Tampilkan harga konsultasi -->
                <td>
